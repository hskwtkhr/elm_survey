...
export default function ManageQuestionsModal({
  ...
  const [activeTab, setActiveTab] = useState<'doctors' | 'menus'>('doctors')
      ...
      <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div className="bg-white rounded-lg p-8 max-w-4xl w-full max-h-[90vh] overflow-y-auto">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-bold">設問管理</h2>
            <button
              onClick={handleClose}
            ...
            {activeTab === 'doctors' ? (
              <div className="space-y-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 mb-4">
                  <h3 className="font-semibold text-blue-900 mb-2">先生名の管理について</h3>
              ...
              <div className="space-y-4">
                <div className="bg-indigo-50 border border-indigo-200 rounded-lg p-4 mb-4">
                  <h3 className="font-semibold text-indigo-900 mb-2">施術メニューの管理について</h3>
